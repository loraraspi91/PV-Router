...
NOUVEAUTE: La sortie 1 peut désormais piloter un SSR gradateur. 
...
* : Cette fonction n’est disponible que lorsque le PV-Router est connecté via WiFi à internet ou avec l'option horloge Temps-réel (RTC) si le WiFi n'est pas disponible. En effet, il prend son horloge sur internet via le WiFi. 
